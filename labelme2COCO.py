...
class labelme2coco(object):
    def __init__(self,labelme_json=[],save_json_path='./test.json'):
        '''
    ...
    def image(self,data,num):
        ...
        img=io.imread('data/test/'+data['imagePath']) # 通过图片路径打开图片
    ...
    def annotation(self,points,label,num):
        annotation={}
        annotation['segmentation']=[list(np.asarray(points,float).flatten())]
...
labelme_json=glob.glob('data/test/*.json')
# labelme_json=['./1.json']
